...
class Game {
    ...
    endGame () {
       ...
       // let gameOver = new Entity(this, this.width / 2, "auto", this.width / 4, this.height / 4, 0, GAME_OVER_PICTURE);
        //let youWin= new Entity(this,this.width/2,"auto",this.width/4,this.height/4,0,YOU_WIN);
    ...
    render () {
        ...
        document.getElementById("scoreli").innerHTML= "Score: x".replace(/x/,this.score);
        document.getElementById("livesli").innerHTML= "Lives: y".replace(/y/,this.player.lives);
    }
}
